...
function ClientForm({ onSuccess, onClose }) {
  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
      ...
      <div>
        {lbl('E-mail')}
        <input type="text" inputMode="email" autoComplete="email" autoCorrect="off" autoCapitalize="none" spellCheck="false" value={form.email} onChange={e=>set('email',e.target.value)} placeholder="cliente@email.com" style={inp()}/>
      </div>
